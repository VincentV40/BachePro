...
export default function LateraleDroite({ projetId }: Props) {
  ...
  const params = projet?.params as LateraleDroiteParams | undefined;
  ...
  const setParam = useCallback(
    <K extends keyof LateraleDroiteParams>(key: K, value: LateraleDroiteParams[K]) => {
      if (!params) return;
