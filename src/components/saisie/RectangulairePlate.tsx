...
import type { RectangulairePlateParams, OeilletConfig, OptionsPatronage } from "@/engine/types";
import { genererPanneaux } from "@/engine/typologies/rectangulaire-plate";
...
export default function RectangulairePlate({ projetId }: Props) {
  ...
  const params = projet?.params as RectangulairePlateParams | undefined;
  ...
  const setParam = useCallback(
    <K extends keyof RectangulairePlateParams>(key: K, value: RectangulairePlateParams[K]) => {
      if (!params) return;
